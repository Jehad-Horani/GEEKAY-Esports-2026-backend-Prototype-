...
const COUNTRY_DATABASE: { keys: string[]; flag: string; name: string; code: string }[] = [
  ...
  { keys: ['saudi arabia', 'saudi', 'ksa', 'sa', 'المملكة العربية السعودية', 'السعودية'], flag: '🇸🇦', name: 'Saudi Arabia', code: 'SA' },
  { keys: ['jordan', 'jordanian', 'jo', 'الأردن'], flag: '🇯🇴', name: 'Jordan', code: 'JO' },
  { keys: ['egypt', 'egyptian', 'eg', 'مصر'], flag: '🇪🇬', name: 'Egypt', code: 'EG' },
  { keys: ['uae', 'united arab emirates', 'emirates', 'emirati', 'ae', 'الإمارات'], flag: '🇦🇪', name: 'United Arab Emirates', code: 'AE' },
  { keys: ['kuwait', 'kuwaiti', 'kw', 'الكويت'], flag: '🇰🇼', name: 'Kuwait', code: 'KW' },
  { keys: ['bahrain', 'bahraini', 'bh', 'البحرين'], flag: '🇧🇭', name: 'Bahrain', code: 'BH' },
  { keys: ['qatar', 'qatari', 'qa', 'قطر'], flag: '🇶🇦', name: 'Qatar', code: 'QA' },
  { keys: ['oman', 'omani', 'om', 'عمان'], flag: '🇴🇲', name: 'Oman', code: 'OM' },
  { keys: ['morocco', 'moroccan', 'ma', 'المغرب'], flag: '🇲🇦', name: 'Morocco', code: 'MA' },
  { keys: ['algeria', 'algerian', 'dz', 'الجزائر'], flag: '🇩🇿', name: 'Algeria', code: 'DZ' },
  { keys: ['tunisia', 'tunisian', 'tn', 'تونس'], flag: '🇹🇳', name: 'Tunisia', code: 'TN' },
  { keys: ['iraq', 'iraqi', 'iq', 'العراق'], flag: '🇮🇶', name: 'Iraq', code: 'IQ' },
  { keys: ['lebanon', 'lebanese', 'lb', 'لبنان'], flag: '🇱🇧', name: 'Lebanon', code: 'LB' },
  { keys: ['syria', 'syrian', 'sy', 'سوريا'], flag: '🇸🇾', name: 'Syria', code: 'SY' },
  { keys: ['palestine', 'palestinian', 'ps', 'فلسطين'], flag: '🇵🇸', name: 'Palestine', code: 'PS' },
